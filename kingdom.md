---
layout: default
title: "The Kingdom — All Connected"
description: "Every app, every project, every expression of the same story — one kingdom, many rooms."
permalink: /kingdom/
---

<section class="page-header">
  <h1>The Kingdom</h1>
  <p class="page-tagline">One Story · Many Rooms</p>
</section>

<section class="kingdom-intro">
  <div class="intro-content">
    <p>
      My Father's house has many rooms. This is the digital expression of that truth — every app, every project, every creative work connected under one name. Not a portfolio. Not a brand. A kingdom.
    </p>
...
<section class="kingdom-grid">
  ...
  <a href="{{ '/' | relative_url }}#testimonies" class="kingdom-card kingdom-primary">
    ...
    <h3>ChristIAM-</h3>
    <p class="kingdom-tagline">The Testimony</p>
    <p class="kingdom-desc">The foundation of it all — the story of the pit, the rescue, and the name above all names. This Jekyll site is where everything begins and everything connects.</p>
...
<section class="kingdom-vision">
  <h2>The Vision</h2>
  <div class="vision-content">
    <p>
      Every app in this kingdom is a room in the Father's house. Some are furnished and lived in — the testimony is told, the water is flowing, the art is on the walls. Others are still being prepared — empty rooms waiting for their purpose to be revealed.
    </p>
    <p>
      But none of them stand alone. The testimony feeds the foundation. The foundation feeds the art. The art feeds the community. The community feeds the testimony. It's a circle — a kingdom — and it all points back to the One who started it.
    </p>
    <p class="kingdom-verse">
      "You did not choose me, but I chose you and appointed you so that you might go and bear fruit — fruit that will last." — John 15:16
    </p>
    <p>
      This is the fruit. And it will last.
    </p>
  </div>
</section>
...
<section class="kingdom-social">
  <h2>Follow the Kingdom</h2>
  <p class="social-intro">Stay connected. The kingdom is always being built.</p>
  <div class="social-links">
    <!-- Facebook -->
    <a href="#" target="_blank" rel="noopener" class="social-link" aria-label="Facebook" data-platform="facebook">
    ...
    <!-- Instagram -->
    <a href="#" target="_blank" rel="noopener" class="social-link" aria-label="Instagram" data-platform="instagram">
      <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
    ...
    <!-- YouTube -->
    <a href="#" target="_blank" rel="noopener" class="social-link" aria-label="YouTube" data-platform="youtube">
      <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
    ...
    <!-- X (Twitter) -->
    <a href="#" target="_blank" rel="noopener" class="social-link" aria-label="X" data-platform="x">
      <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
    ...
    <!-- TikTok -->
    <a href="#" target="_blank" rel="noopener" class="social-link" aria-label="TikTok" data-platform="tiktok">
      <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
        <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.46-5.72-.01-.4-.03-.8.04-1.2.2-1.8 1.2-3.49 2.62-4.6 1.57-1.24 3.67-1.79 5.65-1.39.02 1.48.01 2.95.02 4.43-.82-.27-1.77-.19-2.49.35-.83.55-1.3 1.55-1.25 2.54-.07 1.4 1.16 2.65 2.53 2.64 1.42.15 2.76-.99 2.82-2.4.04-3.4.01-6.79.03-10.18z"/>
      </svg>
      <span>TikTok</span>
    </a>
  </div>
